    ...
    <div class="position-sticky">
        <ul class="nav flex-column">
            ...
            <?php if($_SESSION['usuario']['rol'] == 1) { ?>
                <li class="nav-item">
                    <a class="nav-link" href="/UD4/entregaTarea/init.php">Inicializar</a>
                </li>
            <?php } ?>
            
            <?php if($_SESSION['usuario']['rol'] == 1) { ?>
                <li class="nav-item">
                    <a class="nav-link" href="/UD4/entregaTarea/usuarios/usuarios.php">Lista de usuarios</a>
                </li>
            <?php } ?>  
            ...
            <li class="nav-item">
                <a class="nav-link" href="/UD4/entregaTarea/tareas/tareas.php">Lista de tareas</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/UD4/entregaTarea/controlador/logout.php" >Salir</a>
            </li>
        </ul>
<!-- Incluimos ruta absoluta en form para que se pueda acceder desde cualquier página cuando se pulse "Aplicar" en menú -->
        <form class="m-3 w-50" action="/UD4/entregaTarea/controlador/tema.php" method="POST">
